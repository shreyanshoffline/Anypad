...
*(Note: Replace these placeholder paths with your actual image files when you push to GitHub!)*

### Overall Hackpad
![Overall Hackpad](./images/overall.jpg)
...
* **RGB Everything:** 13 total SK6812 MINI-E addressable LEDs (9 per-key backlights + 4 corner underglows for a seamless desk halo effect).

## 🧰 Bill of Materials (BOM)

| Component | Quantity | Notes |
| :--- | :---: | :--- |
| Seeed Studio XIAO RP2040 | 1 | The brain of the operation |
| Cherry MX-style Switches | 9 | Tactile or Linear (whatever fits your playstyle) |
...
| SK6812 MINI-E LEDs | 13 | 9 for switches, 4 for bottom underglow |
...
This layout strat frees up the remaining pins perfectly for the I2C OLED (2 pins), the Rotary Encoder (2 pins), and a single data line chained through all 13 NeoPixels without needing to resort to hidden pads or larger microcontrollers. 
